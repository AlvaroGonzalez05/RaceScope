...
\begin{enumerate}
    \item \textbf{Fuente de datos: \needcite{OpenF1}.} API pública que proporciona tiempos de vuelta, stints y compuestos de neumático, telemetría del vehículo y datos meteorológicos por sesión.

    \item \textbf{Ingestión y preprocesamiento.} Un \textit{pipeline} Python descarga los datos sesión a sesión, los valida y los transforma en una \textit{feature store} columnar en formato \needcite{Apache Parquet}.
