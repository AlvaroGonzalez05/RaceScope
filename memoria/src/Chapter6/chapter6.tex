...
A medio plazo, el modelo de ritmo admite tres direcciones de expansión. Primero, incorporar más temporadas a medida que estén disponibles, con especial atención al solapamiento entre años para amortiguar la deriva temporal observada en la evaluación de 2025. Con esto se deberá tener mucho cuidado, ya que el cambio de normativa técnica de F1 a partir de 2026 (FIA) \cite{fia2026technical} hace que se empiece prácticamente de cero en términos de datos históricos, y que la ventana de entrenamiento se reduzca drásticamente. En parte por esto se ha decidido no incluir datos posteriores a 2025, y abarcar únicamente la generación de monoplazas de Fórmula~1 de efecto suelo (\textit{ground effect}) vigente desde 2022 hasta 2025 reglamento técnico FIA \cite{fia2026technical}.
