...
% - Explorar N-BEATS o PatchTST como baseline temporal alternativo.
% - Integrar modelos fundacionales de series temporales como TimesFM.
% - Modelar el undercut/overcut con un modelo de tráfico explícito.
% - Añadir cuantificación de incertidumbre.
